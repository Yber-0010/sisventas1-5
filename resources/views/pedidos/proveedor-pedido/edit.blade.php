...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <div class="form-group">
            <h2>Editar pedido proveedor</h2>
        </div>
    </div>
</div>
{{-- {!!Form::open(['url'=>'pedidos/proveedor-pedido', 'method'=>'POST','autocomplete'=>'off']) !!} --}}
{!!Form::model($pedidos,['method'=>'PATCH','route'=>['proveedor-pedido.update',$pedidos->id]])!!}
{{Form::token()}}
<div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
    ...
    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        ...
        <div class="col-lg-12 col-sm-6 col-md-6 col-xs-12" id="guardar">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div style="border: cornflowerblue 2px solid;" class="radio">
                <label for="">
                <input type="radio" name="recibido" value="1">
                Recibido</label>
                <label for="">
                <input type="radio" name="recibido" value="2">
                No recibido</label>
                </div>
            </div>
    ...
    function agregar(control) 
     {
       if(control == 1) {
         $("#campos_otro").hide();
         var detalle = @json($detalles_pedido_proveedor);
         var detalleNull = @json($detalles_pedido_proveedor_null);
         for(let i=0;i<detalle.length;i++) {
            id_detalle = detalle[i].id_detalle;
            otro = detalle[i].otro;
            ...
            precio_compra = detalle[i].precio_compra;
            stock = detalle[i].stock;
            subtotal[cont] = (cantidad*precio_compra-descuento);
            total = total + subtotal[cont];    
            
            
            var fila = '<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+'); ">X</button></td><td><input type="hidden" name="id_detalle[]" value="'+id_detalle+'"><input type="hidden" name="idarticulo[]" value="'+idarticulo+'"><input type="hidden" name="otro[]" value="">'+articulo+'</td><td><input readonly="readonly" type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input readonly="readonly" type="number" name="stock[]" value="'+stock+'"></td><td><input readonly="readonly" type="number" name="precio_compra[]" value="'+precio_compra+'"></td><td><input readonly="readonly" type="number" name="descuento[]" value="'+descuento+'"></td><td>'+subtotal[cont].toFixed(2)+'</td></tr>';
         ...
         for(let i=0;i<detalleNull.length;i++) {
            id_detalle = detalleNull[i].id_detalle;
            ...
            precio_compra = detalleNull[i].precio_compra;
            subtotal[cont] = (cantidad*precio_compra-descuento);
            total = total + subtotal[cont];    
            
            var fila = '<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+'); ">X</button></td><td style="color:blue;"><input type="hidden" name="id_detalle[]" value="'+id_detalle+'"><input type="hidden" name="idarticulo[]" value=""><input type="hidden" name="otro[]" value="'+otro+'">'+otro+'</td><td><input readonly="readonly" type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input readonly="readonly" type="number" name="stock[]" value=""></td><td><input readonly="readonly" type="number" name="precio_compra[]" value="'+precio_compra+'"></td><td><input readonly="readonly" type="number" name="descuento[]" value="'+descuento+'"></td><td>'+subtotal[cont].toFixed(2)+'</td></tr>';
       ...
       if (control == 4) {
         ...
         if ( cantidad!=""&& cantidad > 0  && descuento!="" && precio_venta!="" && precio_compra!=""&& cantidad % 1 == 0) 
         {
           ...
           var fila = '<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+'); ">X</button></td><td style="color:blue;"><input type="hidden" name="idarticulo[]" value=""><input type="hidden" name="otro[]" value="'+articulo+'">'+articulo+'</td><td><input readonly="readonly" type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input readonly="readonly" type="number" name="stock[]" value=""></td><td><input readonly="readonly" type="number" name="precio_compra[]" value="'+precio_compra+'"></td><td><input readonly="readonly" type="number" name="descuento[]" value="'+descuento+'"></td><td>'+subtotal[cont].toFixed(2)+'</td></tr>';
