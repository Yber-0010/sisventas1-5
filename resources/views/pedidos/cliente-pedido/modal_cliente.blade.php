<div class="modal fade modal-slide-in-rigth" aria-hidden="true" role="dialog" tabindex="-1" id="modal_cliente">
       ...
       <div class="modal-content" style="background: rgb(227, 227, 255)">
           ...
           <div class="modal-body">
            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                  <button class="btn btn-primary" type="submit" id="count_click_cliente" name="count_click_cliente">Guardar</button>
            ...
            <!---->    
            {!!Form::close()!!}
            <button id="habilitar_cliente" class="btn btn-secondary">
...
$(document).ready(function(){
    $("#count_click_cliente").click(function()
    {
        count_click_add_cliente();
    });
...
function deshabilitar_cliente(){
    document.getElementById('count_click_cliente').disabled=true;
}
function habilitar_cliente(){
    document.getElementById('count_click_cliente').disabled=false;
}
function count_click_add_cliente(){
   count_click += 1;
